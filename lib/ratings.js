...
function generateRatings(fg3PtPct, fgPct, weight, height, gamesPlayed, blkPerGame) {
    ...
    let ovrRtng = Math.ceil((fg3PtRtng + mdRngRtng + clRngRtng + postCntlRtng + blkRating) / 5);
    return {
        'fg3PtRtng':fg3PtRtng,
        'mdRngRtng':mdRngRtng,
        'clRngRtng':clRngRtng,
...
module.exports.generate = function(playerStatsAt, playerPlayerAt) {
    ...
    return generateRatings(fieldGoals.fg3PtPct, fieldGoals.fgPct, playerPlayerAt.weight, playerPlayerAt.height, gamesPlayed, defense.blkPerGame);
};
